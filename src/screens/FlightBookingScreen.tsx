...
interface FlightBookingScreenProps {
    onBackPress: () => void;
    flight: FlightData;
}
...
export const FlightBookingScreen = ({
    onBackPress,
    flight,
}: FlightBookingScreenProps) => {
    return (
            ...
            <SafeAreaView edges={['top']} style={styles.safeArea}>
                ...
                <View style={styles.header}>
                    ...
                    <View style={styles.headerTitleContainer}>
                        ...
                        <Text style={styles.headerSubtitle}>1 Adult • {flight?.class || 'Economy'}</Text>
                    </View>
                    ...
                    <View style={styles.card}>
                        <View style={styles.flightSummaryHeader}>
                            <View style={styles.flightSummaryHeaderLeft}>
                                ...
                                <Text style={styles.summaryDate}>Thu, 2 Oct • Economy • Direct</Text>
                            </View>
                            ...
                            <View style={styles.timelineContent}>
                                ...
                                <View style={styles.timelineItem}>
                                    <View style={styles.timeWrapper}>
                                        <Text style={styles.timeText}>{flight?.departureTime || '06:45'}</Text>
                                    ...
                                    <View style={styles.placeWrapper}>
                                        <View style={styles.cityRow}>
                                            ...
                                            <View style={styles.codeTag}>
                                                <Text style={styles.codeTagText}>{flight?.departureCode || 'KUL'}</Text>
                                            </View>
                                        </View>
                                        <View style={styles.airlineRow}>
                                            <Image source={flight?.logo || require('../assets/airlines/scoot.png')} style={styles.airlineLogo} />
                                            <Text style={styles.airlineName}>{flight?.airline || 'Scoot'}</Text>
                                        </View>
                                    </View>
                                </View>
                                ...
                                <View style={[styles.timelineItem, { marginTop: spacing.l }]}>
                                    <View style={styles.timeWrapper}>
                                        <Text style={styles.timeText}>{flight?.arrivalTime || '07:55'}</Text>
                                        <Text style={styles.dateSmall}>02 Oct</Text>
                                    </View>
                                    <View style={styles.placeWrapper}>
                                        <View style={styles.cityRow}>
                                            ...
                                            <View style={styles.codeTag}>
                                                <Text style={styles.codeTagText}>{flight?.arrivalCode || 'SIN'}</Text>
                                            </View>
                                        </View>
                                    </View>
                                </View>
                            ...
                            <View style={styles.ticketHeader}>
                                <View>
                                    ...
                                    <Text style={styles.ticketPrice}>
                                        {ticket.price}<Text style={styles.ticketPax}>/pax</Text>
                                    </Text>
                                </View>
                            ...
                            <View style={styles.benefitsContainer}>
                                <View style={styles.benefitRow}>
                                    <View style={[styles.iconCircle, { backgroundColor: '#FFD700' }]}>
                                        {/* Placeholder for Airline specific icon/logo if needed */}
                                        <Text style={{ fontSize: 10, fontWeight: 'bold' }}>S</Text>
                                    </View>
                                    <View style={styles.baggageInfo}>
                                        <Briefcase size={16} color="#555" style={{ marginRight: 4 }} />
