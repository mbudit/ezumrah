...
import { ArrowLeft, SlidersHorizontal, ArrowUpDown, Calendar } from 'lucide-react-native';
                ...
                {displayedFlights.length > 0 ? (
                    displayedFlights.map((flight, index) => (
                        <TouchableOpacity
                            ...
                            onPress={() => onFlightSelect && onFlightSelect(flight)}
                        >
                            <View style={styles.flightMainRow}>
                                <View style={styles.flightRouteContainer}>
                                    ...
                                    <View style={styles.flightDurationContainer}>
                                        ...
                                        <Text style={styles.directText}>{flight.isDirect ? 'Direct' : 'Stop'}</Text>
                                    </View>
                            ...
                            <View style={styles.flightBottomRow}>
                                <View style={styles.airlineInfo}>
                                    ...
                                    <View style={{ width: 20, height: 20, borderRadius: 10, backgroundColor: '#FFD700', marginRight: 8, alignItems: 'center', justifyContent: 'center' }}>
                                        <Text style={{ fontSize: 8, fontWeight: 'bold', color: 'black' }}>S</Text>
                                    </View>
                                    <Text style={styles.airlineText}>{flight.airline} · {flight.class}</Text>
                                </View>

                                {flight.nonRefundable && (
                                    <View style={styles.tagContainer}>
                                        <Text style={styles.tagText}>Refund & reschedule not allowed</Text>
                                    </View>
                                )}
                            </View>
                        </TouchableOpacity>
