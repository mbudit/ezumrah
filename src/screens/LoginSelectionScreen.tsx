...
export const LoginSelectionScreen: React.FC<Props> = ({ navigation }) => {
  return (
      ...
      <View style={styles.content}>
        ...
        <View style={styles.textContainer}>
          <Text style={[typography.h1, styles.title]}>
            Your Worship Travel Companion
          </Text>
          <Text style={[typography.body, styles.description]}>
            EZUMRAH.com making your worship journey with ease and
            well-organized. Every sacred step is now within your grasp.
          </Text>
        </View>
